...
public abstract class Hilt_BookmarkFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookmarkFragment() {
    super();
  }

  Hilt_BookmarkFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookmarkFragment_GeneratedInjector) this.generatedComponent()).injectBookmarkFragment(UnsafeCasts.<BookmarkFragment>unsafeCast(this));
    }
  }
