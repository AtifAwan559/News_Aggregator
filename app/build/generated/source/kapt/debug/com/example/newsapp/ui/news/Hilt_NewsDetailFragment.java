...
public abstract class Hilt_NewsDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsDetailFragment() {
    super();
  }

  Hilt_NewsDetailFragment(int contentLayoutId) {
