...
public abstract class Hilt_NewsFeedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsFeedFragment() {
    super();
  }

  Hilt_NewsFeedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsFeedFragment_GeneratedInjector) this.generatedComponent()).injectNewsFeedFragment(UnsafeCasts.<NewsFeedFragment>unsafeCast(this));
    }
  }
