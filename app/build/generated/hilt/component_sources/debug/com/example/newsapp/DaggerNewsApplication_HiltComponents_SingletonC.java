...
import com.example.newsapp.ui.bookmarks.BookmarkFragment;
...
import com.example.newsapp.ui.main.MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.newsapp.ui.main.MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.example.newsapp.ui.news.NewsDetailFragment;
import com.example.newsapp.ui.news.NewsFeedFragment;
import com.example.newsapp.ui.news.NewsViewModel;
import com.example.newsapp.ui.news.NewsViewModel_HiltModules;
import com.example.newsapp.ui.news.NewsViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.newsapp.ui.news.NewsViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerNewsApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends NewsApplication_HiltComponents.FragmentC {
    ...
    @Override
    public void injectBookmarkFragment(BookmarkFragment arg0) {
    }

    @Override
    public void injectNewsDetailFragment(NewsDetailFragment arg0) {
    }

    @Override
    public void injectNewsFeedFragment(NewsFeedFragment arg0) {
    }
  ...
  private static final class ActivityCImpl extends NewsApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, MainViewModel_HiltModules.KeyModule.provide()).put(NewsViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, NewsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends NewsApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.newsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) mainViewModelProvider)).put(NewsViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) newsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new MainViewModel(singletonCImpl.newsRepositoryImplProvider.get());

          case 1: // com.example.newsapp.ui.news.NewsViewModel 
  ...
  private static final class SingletonCImpl extends NewsApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.newsDataSourceProvider = DoubleCheck.provider(new SwitchingProvider<NewsDataSource>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsapp.data.repository.NewsRepositoryImpl 
          return (T) new NewsRepositoryImpl(singletonCImpl.newsDataSourceProvider.get());

          case 1: // com.example.newsapp.data.source.NewsDataSource 
          return (T) new NewsDataSource(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
